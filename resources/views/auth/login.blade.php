        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">login as Doctor  <a href="{{ route('logindoctor') }}" class="fw-semibold text-primary text-decoration-underline"> Login </a> </p>
                    </div>

                    <div class="mt-4 text-center">
                        <p class="mb-0">Don't have an account sign up as doctor ? <a href="{{ route('registerdoctor')  }}" class="fw-semibold text-primary text-decoration-underline"> Signup </a> </p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> HangingPanda.Crafted with <i class="mdi mdi-heart text-danger"></i></p>
                    </div>
                </div>
            </div>
        </div>
