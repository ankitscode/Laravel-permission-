        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="card-body text-center">
                    <img class="rounded-circle mb-2 avater-ext" src="{{asset("assets/images/users/user-dummy-img.jpg")}}" alt="" style="height: 10rem;width: 10rem;">
    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" id="changePasswordForm" action="{{route('changePasswordStore')}}" enctype="multipart/form-data">
                    @csrf
