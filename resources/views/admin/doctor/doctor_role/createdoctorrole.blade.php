    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" action="{{ route('doctor.storeRole') }}" id="storeRole">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('role_name') is-invalid @enderror"
                                        ...
                                        placeholder="{{ __('main.Enter Role Name') }}" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="row">
