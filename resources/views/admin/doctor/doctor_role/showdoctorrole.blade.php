                    ...
                    <div class="d-flex align-items-center">
                        ...
                        @canany(['Edit Role', 'Delete Role'])
                            <div class="flex-shrink-0">
                                @can('Edit Role')
                                    <a href="{{ route('doctor.editRole', $role->id) }}" class="btn btn-primary btn-sm"><i
                                            class="ri-edit-2-line align-middle me-1"></i> {{ __('main.edit') }}</a>
                                @endcan
                            </div>
                        @endcan
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-muted"><span
                                            class="badge badge-soft-primary fs-12">{{ $role->name }}</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-group">
                                            <ul style="list-style-type: none;padding-inline-start: 15px;">
                                                <li>
                                                    <h6><i class="mdi mdi-link-variant"></i><strong>
                                                            {{ ucwords($group) }}</strong></h6>
