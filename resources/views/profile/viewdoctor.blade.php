    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4 h-100">
            <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-primary flex-grow-1">{{ __('main.doctor_details') }}</h6>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless mb-0">
                        <tbody>
                            <tr>
                                <td class="font-bold-600" style="width: 25%;">{{ __('main.name') }}</td>
                                <td>{{ $doctor->name }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="font-bold-600" style="width: 25%;">{{ __('main.degree') }}</td>
                                <td>{{ $doctor->degree }}</td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="card-body">
                <div class="card-body text-center">
                    ...
                    <div class="large text-muted mb-4">
                        <span
                            class="badge rounded-pill badge-outline-{{ $doctor->is_active == 1 ? 'success' : 'danger' }}">
                            {{ $doctor->is_active ? __('main.active') : __('main.in_active') }}
                        </span>
                    </div>
                </div>
            </div>
